...
/*
Plugin Name:	Forked Embed Privacy
...
\define( 'EMBED_PRIVACY_VERSION', '2.2.1' );

if ( ! \defined( 'EPI_EMBED_PRIVACY_BASE' ) ) {
	\define( 'EPI_EMBED_PRIVACY_BASE', \WP_PLUGIN_DIR . '/fd-og-embed-privacy/' );
}
...
require_once dirname( __FILE__ ) . '/fd-embed-privacy/fd-embed-privacy.php';
